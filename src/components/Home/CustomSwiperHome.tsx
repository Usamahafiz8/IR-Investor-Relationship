...
const HomeCustomSwiper = ({blog}:any) => {
                          ...
                          <div className="bd-blog-4 d-flex align-items-end bg-gray-300">
                            ...
                            <div className="bd-blog-4__content">
                              <div className="bd-blog-4__meta">
                                ...
                                {new Date(item.attributes.publishedAt).getDate()}
                                  <br />
                                  {new Date(item.attributes.publishedAt).toLocaleString('default', { month: 'long' })}
                                </Link>
                              </div>
                              <h4 className="bd-blog-4__title">
                                <Link href={`/blog-details/${item.id}`}>
                                  {truncateText(item.attributes.title , 50)}
                                </Link>
                              </h4>
                            </div>
                          </div>
...
export default HomeCustomSwiper;
